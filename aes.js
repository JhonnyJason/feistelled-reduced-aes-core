...
export class AESEngine {
    ...
    prepare() {
        ...
        this._KeL8[3] = this._Ke[this.rounds][0] & 0xff

        this._KeL8[4] = (this._Ke[this.rounds][1] >> 24) & 0xff
        this._KeL8[5] = (this._Ke[this.rounds][1] >> 16) & 0xff
        this._KeL8[6] = (this._Ke[this.rounds][1] >> 8) & 0xff
        this._KeL8[7] = this._Ke[this.rounds][1] & 0xff

        this._KeL8[8] = (this._Ke[this.rounds][2] >> 24) & 0xff
        this._KeL8[9] = (this._Ke[this.rounds][2] >> 16) & 0xff
        this._KeL8[10] = (this._Ke[this.rounds][2] >> 8) & 0xff
        this._KeL8[11] = this._Ke[this.rounds][2] & 0xff

        this._KeL8[12] = (this._Ke[this.rounds][3] >> 24) & 0xff
    ...
    feistelDigest(counter) {
        ...
        //0: xor left side with base key and counter
        ke = this._Ke[0]
        ...
        //1: apply PRF on left side -> 2 round transforms
        ke = this._Ke[1]

        a1 = T1[l8[0]] ^ T2[l8[5]] ^ T3[l8[10]] ^ T4[l8[15]] ^ ke[0];
        a2 = T1[l8[4]] ^ T2[l8[9]] ^ T3[l8[14]] ^ T4[l8[3]] ^ ke[1];
        a3 = T1[l8[8]] ^ T2[l8[13]] ^ T3[l8[2]] ^ T4[l8[7]] ^ ke[2];
        a4 = T1[l8[12]] ^ T2[l8[1]] ^ T3[l8[6]] ^ T4[l8[11]] ^ ke[3];
        ...
        //2: right is xored with left side
        r32[0] ^= l32[0]
        r32[1] ^= l32[1]
        r32[2] ^= l32[2]
        r32[3] ^= l32[3]

        //3: apply PRF on right side -> 2 round transforms
        ke = this._Ke[3]

        a1 = T1[r8[0]] ^ T2[r8[5]] ^ T3[r8[10]] ^ T4[r8[15]] ^ ke[0];
        a2 = T1[r8[4]] ^ T2[r8[9]] ^ T3[r8[14]] ^ T4[r8[3]] ^ ke[1];
        a3 = T1[r8[8]] ^ T2[r8[13]] ^ T3[r8[2]] ^ T4[r8[7]] ^ ke[2];
        a4 = T1[r8[12]] ^ T2[r8[1]] ^ T3[r8[6]] ^ T4[r8[11]] ^ ke[3];
        ...
        //4: left is xored with right side
        l32[0] ^= r32[0]
        l32[1] ^= r32[1]
        l32[2] ^= r32[2]
        l32[3] ^= r32[3]

        //5: apply PRF on left side -> 2 round transforms
        ke = this._Ke[5]
